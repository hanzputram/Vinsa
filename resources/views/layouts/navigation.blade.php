<nav x-data="{ open: false }" class="relative z-[10] bg-white border-b shadow-md border-gray-100">
            ...
            <div class="flex ">
                ...
                <div class="hidden sm:flex sm:items-center sm:ms-6">
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            <x-dropdown-link :href="route('products.view')">
                                {{ __('Tambah Produk') }}
                            </x-dropdown-link>
 
                            <!-- Authentication -->
                            <x-dropdown-link :href="route('products.edit')">
                                {{ __('Perbarui Produk') }}
                            </x-dropdown-link>
                        </x-slot>
                    </x-dropdown>
                ...
                <div class="hidden sm:flex sm:items-center">
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            <x-dropdown-link :href="route('carousels.create')">
                                {{ __('Tambah Banner') }}
                            </x-dropdown-link>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1" x-data="{ openProduct: false, openGambar: false }">
            ...
            <div>
                ...
                <div x-show="openProduct" x-collapse class="pl-6 space-y-1">
                    <x-responsive-nav-link :href="route('products.view')" :active="request()->routeIs('products.view')">
                        {{ __('Tambah Product') }}
                    </x-responsive-nav-link>
                    <x-responsive-nav-link :href="route('products.edit')" :active="request()->routeIs('products.edit')">
                        {{ __('Perbarui Product') }}
                    </x-responsive-nav-link>
                </div>
            </div>
