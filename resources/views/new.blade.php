...
<head>
    <!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-N19QP7PTHR"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-N19QP7PTHR');
</script>
    <!-- Google Tag Manager -->
<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
    ...
    })(window,document,'script','dataLayer','GTM-K93C5R3P');</script>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-K93C5R3P"
            ...
            @foreach ($categories as $category)
                ...
                <div class="grid grid-cols-12 row-span-1 gap-4">
                    ...
                    <div class="col-span-12 md:col-span-10 bg-[#5f5f5f60] rounded-xl p-4">
                        <h3 class="text-lg md:hidden font-bold mb-2 border-b-[1.5px] pb-2 border-white">-
                            {{ $category->name }}</h3>
