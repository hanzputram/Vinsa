            ...
            <div class="relative z-[10] max-w-7xl mx-auto w-full px-6 pb-16 grid lg:grid-cols-5 gap-8 lg:gap-12">
                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <a href="https://wa.me/6281335715398" target="_blank" rel="noopener noreferrer" class="group flex items-center gap-4 bg-white/10 backdrop-blur-xl p-6 rounded-2xl border border-white/20 hover:bg-white/15 transition-all hover:scale-[1.02]">
                        ...
                        <a href="https://www.instagram.com/vinsa.fr" target="_blank" rel="noopener noreferrer" class="group flex items-center gap-4 bg-white/10 backdrop-blur-xl p-6 rounded-2xl border border-white/20 hover:bg-white/15 transition-all hover:scale-[1.02]">
                            <div class="p-3 rounded-xl bg-[#E4405F]/30 group-hover:bg-[#E4405F]/40 transition-all">
                                <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <div>
                                <p class="text-xs font-bold text-white/60 uppercase tracking-wider">{{ __('Instagram') }}</p>
                                <p class="text-lg font-semibold text-white">@vinsa.fr</p>
                            </div>
                        </a>
