...
<body class="overflow-x-hidden w-full hide-scrollbar">
    ...
    <a href="https://wa.me/6282223332830">
        <div class="w-[75px] h-[75px] fixed bottom-[20px] left-[20px] z-[1000] bg-[#ffffff4d] rounded-full backdrop-blur-[2px] flex items-center justify-center">
            <img class="wa-text-curv flex items-center justify-center" src="/image/war.png" alt=""><svg width="30px" height="30px" fill="#000000" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M11.42 9.49c-.19-.09-1.1-.54-1.27-.61s-.29-.09-.42.1-.48.6-.59.73-.21.14-.4 0a5.13 5.13 0 0 1-1.49-.92 5.25 5.25 0 0 1-1-1.29c-.11-.18 0-.28.08-.38s.18-.21.28-.32a1.39 1.39 0 0 0 .18-.31.38.38 0 0 0 0-.33c0-.09-.42-1-.58-1.37s-.3-.32-.41-.32h-.4a.72.72 0 0 0-.5.23 2.1 2.1 0 0 0-.65 1.55A3.59 3.59 0 0 0 5 8.2 8.32 8.32 0 0 0 8.19 11c.44.19.78.3 1.05.39a2.53 2.53 0 0 0 1.17.07 1.93 1.93 0 0 0 1.26-.88 1.67 1.67 0 0 0 .11-.88c-.05-.07-.17-.12-.36-.21z"></path><path d="M13.29 2.68A7.36 7.36 0 0 0 8 .5a7.44 7.44 0 0 0-6.41 11.15l-1 3.85 3.94-1a7.4 7.4 0 0 0 3.55.9H8a7.44 7.44 0 0 0 5.29-12.72zM8 14.12a6.12 6.12 0 0 1-3.15-.87l-.22-.13-2.34.61.62-2.28-.14-.23a6.18 6.18 0 0 1 9.6-7.65 6.12 6.12 0 0 1 1.81 4.37A6.19 6.19 0 0 1 8 14.12z"></path></g></svg>
        </div>
    </a>    
     <!-- Background Section -->
    <div class="relative bg-no-repeat bg-cover w-full" style="background-image:url('/image/pabrik.jpg')">
        ...
        <nav class="relative z-10 text-[#066C5F] py-4 px-6 shadow-md">
            <div class="container mx-auto flex justify-between items-center">
                ...
                <ul class="hidden md:flex space-x-6">
                    <li><a href="{{ url('/') }}" class="font-bold text-xl hover:text-[#066c5fad]">Dashboard</a></li>
            ...
            <div id="mobile-menu" class="hidden md:hidden p-4">
                <a href="{{ url('/') }}" class="block py-2 text-[#066C5F] border-b-[1.5px] hover:text-[#066c5fad] font-bold">Dashboard</a>
        ...
        <p class="mt-4 mb-10 text-lg  font-medium text-[#066c5f] max-w-2xl">"Vinsa: Dedikasi dalam Menyediakan Solusi Kelistrikan Premium, Menghadirkan Produk Berkualitas Tinggi untuk Kebutuhan Rumah, Bisnis, dan Industri Anda!"</p>
            <div class="mt-6 flex space-x-4">
                ...
                <a href="{{ route('contact-us') }}" class="border-2 border-[#F77F1E] text-[#000000] px-6 py-3 rounded-full transition-all duration-300 ease-in-out shadow hover:bg-[#F77F1E] hover:text-white">CONTACT US</a>
            </div>
            {{-- arrow down --}}
            <a href="#second">
                <svg 
