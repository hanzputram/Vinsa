...
<nav x-data="{ sidebarOpen: false, clickCount: 0, resetTimer: null }" x-effect="document.body.classList.toggle('overflow-hidden', sidebarOpen)"
    class="relative z-[1000] w-full flex justify-between items-center text-[#066C5F] px-6 py-4">

    <!-- Logo -->
    <div>
        <img id="logo" src="/image/vinsalg.png" width="80px" height="80px" alt="Logo Vinsalg" class="cursor-pointer"
            @click="
        clickCount++;
        if (clickCount >= 5) {
    ...
    <div>
        ...
        <ul class="hidden md:flex space-x-6">
            ...
            <li><a href="https://wa.me/6282223332830" class="font-bold text-xl hover:text-[#066c5fad]">Contact Us</a></li>
        </ul>
    </div>
    ...
    <div class="fixed top-0 right-0 w-64 h-full bg-[#FFFCF0] shadow-lg p-4 z-[30] transform transition-transform duration-300 ease-in-out"
        ...
        <a href="{{ url('/contact') }}" class="block py-2 text-[#066C5F] hover:text-[#066c5fad] font-bold">Contact
            Us</a>
    </div>
</nav>
