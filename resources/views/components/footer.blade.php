        ...
        <div class="grid lg:grid-cols-4 gap-12 mb-20">
            ...
            <div class="lg:col-span-1 border-r border-gray-200 pr-10">
                ...
                <div class="flex gap-4">
                    <a href="https://wa.me/6281335715398" target="_blank" rel="noopener noreferrer" class="p-3 bg-gray-50 rounded-2xl hover:bg-[#0dd8bd] hover:text-white transition-all group border border-gray-200" title="WhatsApp" aria-label="WhatsApp">
                    ...
                    <a href="https://www.instagram.com/vinsa.fr" target="_blank" rel="noopener noreferrer" class="p-3 bg-gray-50 rounded-2xl hover:bg-[#0dd8bd] hover:text-white transition-all group border border-gray-200" title="Instagram @vinsa.fr" aria-label="Instagram">
                        <svg class="w-5 h-5 text-[#066c5f] group-hover:text-white" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="mailto:sales@ATstekno.com" class="p-3 bg-gray-50 rounded-2xl hover:bg-[#0dd8bd] hover:text-white transition-all group border border-gray-200" title="Email" aria-label="Email">
